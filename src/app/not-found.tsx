...
export default function NotFound() {
  ...
  return (
    // This boundary renders outside the app shell — no sidebar, no canvas — so
    // it was the one page a user could still reach that was bare background.
    // A mistyped URL is a bad enough moment without the product looking broken.
    <div className="relative isolate min-h-dvh">
      <ShellBackdrop anchor="viewport" />

      <main className="relative z-10 mx-auto flex min-h-[calc(100vh-8rem)] w-full max-w-[1180px] items-center px-4 py-6 md:px-8 md:py-8">
        <Empty
