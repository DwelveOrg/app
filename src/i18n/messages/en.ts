      ...
      root: {
        ...
        tests: {
          ...
          create: {
            ...
            formatBlurb: {
              SIMPLE_QUIZ: "One section. The fastest way to a short quiz.",
              IELTS: "Reading and Writing sections, timed like the real paper.",
              SAT: "Two Reading & Writing modules and two Math modules.",
              CUSTOM: "One section to start, and you add your own.",
              generic: "Starts with {{count}} sections.",
            },
            preview: {
              sections: "You will start with",
              questionTypes: "Question types",
              noDuration: "Set at publish",
              note: "Nothing here is final. Sections, timing and rules can all change before you publish.",
            },
          },
          delete: {
            title: "Delete \"{{title}}\"?",
          ...
          publish: {
            ...
            stepsLabel: "Publish steps",
            recheck: "Check again",
            fixInBuilder: "Fix in the builder",
            confirmAnyway: "Publish without them",
            steps: {
              readiness: "Check",
              timing: "Timing",
              integrity: "Rules",
            ...
            headings: {
              readiness: "Is this test ready?",
              timing: "When and for how long?",
              integrity: "Exam rules",
              results: "What do students see afterwards?",
              confirm: "Ready to publish",
            },
            blurbs: {
              readiness: "Everything below is checked against the saved version of the test.",
              timing: "How long students get, when the test is open, and how many attempts.",
              integrity: "Nothing here is on by default. Turn on only what this test needs.",
              results: "Scores, the answer key, and feedback are three separate decisions.",
              confirm: "Publishing notifies every student in the class. Check this reads the way you meant it.",
            },
            presets: {
              label: "Start from",
              practice: "Practice",
            ...
            aside: {
              ...
              body: "It runs the same rules the server runs when it publishes, so nothing here is a guess. Fix a problem in the builder and come back — the list re-checks itself.",
            },
            timing: {
              limit: "Time limit",
            ...
            summary: {
              ...
              open: "Open book",
              noRules: "No exam restrictions. Students take it like homework.",
              violationLimit: "The attempt ends after {{count}} recorded violations.",
              notifyTitle: "Publishing sends a notification",
              notifyBody: "Every student in the class, and the other teachers on it.",
              deliveryUnsupportedTitle: "Exam rules could not be saved",
              deliveryUnsupportedBody: "This server does not store them yet. Publishing now means timing, availability and the score settings apply, but the integrity rules do not.",
              rule: {
                requireFullscreen: "Fullscreen is required",
                detectLeaveScreen: "Leaving the screen is detected",
                blockCopyPaste: "Copy and paste are blocked",
                blockContextMenu: "The right-click menu is blocked",
                requireHonorCode: "Students agree not to cheat",
                oneAtATime: "One question at a time",
                noBackNavigation: "No going back to an answered question",
                shuffleOptions: "Answer options are shuffled",
              },
            },
          },
          builder: {
            ...
            group: {
              ...
              range: "Q{{from}}–{{to}}",
              addStimulus: "Add a passage",
              editStimulus: "Passage",
