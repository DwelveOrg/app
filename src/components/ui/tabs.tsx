...
/**
 * Generated by `shadcn@latest add tabs` (radix-nova style), with one change:
 * the registry emits `data-active:` variants, which target a newer Radix than
 * the `radix-ui@1.4.3` this project pins. That version still writes
 * `data-state="active"`, so the selectors here are `data-[state=active]:`.
 * Re-running the generator will overwrite this — reapply the swap if you do.
 * The same applies to `checkbox.tsx`, `radio-group.tsx`, and `switch.tsx`.
 */
